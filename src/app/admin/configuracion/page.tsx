...
export default function AdminConfigPage() {
   ...
   async function handleSaveGeneral() {
      ...
      try {
         ...
         toast.success('Configuraciones guardadas correctamente (Persistido).');
      } catch (e: any) {
         console.error(e);
   ...
   const handleSaveSponsor = async (e: React.FormEvent) => {
      ...
      try {
         ...
         toast.error('Error al guardar sponsor: ' + (error.message || error));
      }
   };
   ...
   async function handleAddVenue(e: React.FormEvent) {
      ...
      try {
         ...
         toast.error("Error al agregar sede: " + error.message);
      }
   }
   ...
   async function deleteCategory(id: string) {
      if (confirm('¿Eliminar categoría? Esto podría afectar planteles o torneos existentes.')) {
         try {
   ...
   return (
      <div className="space-y-6 text-white min-h-screen">
         ...
         <div className="flex flex-col gap-4">
            ...
            {/* === GENERAL === */}
            <div className="bg-zinc-900 rounded-2xl border border-zinc-800 shadow-sm overflow-hidden transition-all duration-300">
               <button
                  onClick={() => toggleSection('general')}
                  className="w-full flex items-center justify-between p-6 bg-zinc-900 hover:bg-zinc-800/50 transition-colors"
               >
                  <div className="flex items-center gap-3">
                     <div className="p-2 bg-zinc-800 rounded-lg text-tdf-orange"><Info size={20} /></div>
                     <h2 className="text-xl font-black text-white">General y Contacto</h2>
                  </div>
                  <div className={`transform transition-transform duration-300 text-zinc-500 ${expandedSection === 'general' ? 'rotate-180' : ''}`}>▼</div>
               </button>

               <div className={`transition-all duration-500 ease-in-out ${expandedSection === 'general' ? 'max-h-[2000px] opacity-100 p-6 pt-0 border-t border-zinc-800/50' : 'max-h-0 opacity-0 overflow-hidden'}`}>
               ...
               <div className="bg-zinc-900 rounded-2xl border border-zinc-800 shadow-sm overflow-hidden transition-all duration-300">
                  ...
                  >
                     <div className="flex items-center gap-3">
                        <div className="p-2 bg-zinc-800 rounded-lg text-tdf-blue"><Image size={20} /></div>
                        <h2 className="text-xl font-black text-white">Sponsors Oficiales</h2>
                     </div>
                     <div className={`transform transition-transform duration-300 text-zinc-500 ${expandedSection === 'sponsors' ? 'rotate-180' : ''}`}>▼</div>
                  </button>

                  <div className={`transition-all duration-500 ease-in-out ${expandedSection === 'sponsors' ? 'max-h-[3000px] opacity-100 p-6 pt-0 border-t border-zinc-800/50' : 'max-h-0 opacity-0 overflow-hidden'}`}>
                     <div className="mt-6">
                  ...
                  <div className="bg-zinc-900 rounded-2xl border border-zinc-800 shadow-sm overflow-hidden transition-all duration-300">
                     ...
                     >
                        <div className="flex items-center gap-3">
                           <div className="p-2 bg-zinc-800 rounded-lg text-emerald-500"><Users size={20} /></div>
                           <h2 className="text-xl font-black text-white">Categorías de Competencia</h2>
                        </div>
                        <div className={`transform transition-transform duration-300 text-zinc-500 ${expandedSection === 'categorias' ? 'rotate-180' : ''}`}>▼</div>
                     </button>

                     <div className={`transition-all duration-500 ease-in-out ${expandedSection === 'categorias' ? 'max-h-[2000px] opacity-100 p-6 pt-0 border-t border-zinc-800/50' : 'max-h-0 opacity-0 overflow-hidden'}`}>
                        <div className="mt-6">
         ...
         <div className="bg-zinc-900 rounded-2xl border border-zinc-800 shadow-sm overflow-hidden transition-all duration-300" >
            ...
            >
               <div className="flex items-center gap-3">
                  <div className="p-2 bg-zinc-800 rounded-lg text-red-500"><MapPin size={20} /></div>
                  <h2 className="text-xl font-black text-white">Sedes y Estadios</h2>
               </div>
               <div className={`transform transition-transform duration-300 text-zinc-500 ${expandedSection === 'sedes' ? 'rotate-180' : ''}`}>▼</div>
            </button>

            <div className={`transition-all duration-500 ease-in-out ${expandedSection === 'sedes' ? 'max-h-[2000px] opacity-100 p-6 pt-0 border-t border-zinc-800/50' : 'max-h-0 opacity-0 overflow-hidden'}`}>
               <div className="mt-6">
         ...
         <div className="bg-zinc-900 rounded-2xl border border-zinc-800 shadow-sm overflow-hidden transition-all duration-300" >
            ...
            >
               <div className="flex items-center gap-3">
                  <div className="p-2 bg-zinc-800 rounded-lg text-green-500"><DollarSign size={20} /></div>
                  <h2 className="text-xl font-black text-white">Costos de Trámites Federativos</h2>
               </div>
               <div className={`transform transition-transform duration-300 text-zinc-500 ${expandedSection === 'tramites' ? 'rotate-180' : ''}`}>▼</div>
            </button>

            <div className={`transition-all duration-500 ease-in-out ${expandedSection === 'tramites' ? 'max-h-[2000px] opacity-100 p-6 pt-0 border-t border-zinc-800/50' : 'max-h-0 opacity-0 overflow-hidden'}`}>
